    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DepartmentGroupsId = table.Column<int>(type: "int", nullable: false),
                    UsersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupUsers", x => new { x.DepartmentGroupsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_GroupUsers_DepartmentGroups_DepartmentGroupsId",
                        column: x => x.DepartmentGroupsId,
